...
You could simply physically move the "podcast" directory to a location that resides on your Python path, but would break future Subversion updates.

Then add `podcast` as a tuple item to your `INSTALLED_APPS` in `settings.py`:
...
If you installed the Django admin, you should be able to see the podcast application's show and episode areas:

  * http://www.mywebsite.com/admin/podcast/show/
  * http://www.mywebsite.com/admin/podcast/episode/
...
1. Create original feed URL for FeedBurner
   * http://www.mywebsite.com/podcasts/feedburner/
2. Submit URL to FeedBurner (check box for podcast)
   * http://www.feedburner.com/
3. Copy new FeedBurner URL to clipboard
   * http://feeds.feedburner.com/MyAwesomePodcast
4. Create "friendly" URL for a redirect
   * http://www.mywebsite.com/podcasts/feed/ -> http://feeds.feedburner.com/MyAwesomePodcast
...
6. Promote either "friendly" URL or iTunes URL
   * http://www.mywebsite.com/podcasts/feed/
   * http://phobos.apple.com/WebObjects/MZStore.woa/wa/viewPodcast?id=(iTunes Podcast ID)
   * http://www.itunes.com/podcast?id=(iTunes Podcast ID)
...
The iTunes Store checks new content daily but you might want to make sure a new episode is available immediately in the iTunes Store. Visit the ping URL to make that episode available: https://phobos.apple.com/WebObjects/MZFinance.woa/wa/pingPodcast?id=(iTunes Podcast ID)

== Google video sitemaps ==

If you're creating a video podcast, you can submit a video sitemap to [http://www.google.com/webmasters/tools/ Google Webmaster Tools]. The video sitemap will help Google index videos in Google Video.

After a successful installation, the video sitemap URL should be available at http://www.mywebsite.com/podcasts/sitemap.xml.
 ...
 * [http://www.google.com/support/webmasters/bin/topic.py?topic=10079Google video sitemaps]
...
If you used this Django application, I'd love to see it in action. Drop me a line at rich (at) richardcornish (dot) com and let me know how you're using it.