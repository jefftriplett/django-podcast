...
class Episode(models.Model):
    ...
    image = models.ImageField(upload_to='podcasts/episodes/img/', help_text='A screenshot from the video for inclusion in a Google video sitemap. Podcast artwork must be in the file\'s metadata before uploading!', blank=True)
