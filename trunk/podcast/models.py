...
class Show(models.Model):
    ...
    webmaster = models.ForeignKey(User, related_name='webmaster', blank=True, help_text='Remember to save the user\'s name and e-mail address in the <a href="../../../auth/user/">User application</a>.')
...
class Enclosure(models.Model):
    ...
    file = models.FileField(upload_to='podcasts/episodes/files/', help_text='Must be less than or equal to 30 MB for a Google video sitemap.')
